...
public class ServiceController implements ServiceApi {
    ...
    @Override
    public ResponseEntity<List<CategorySearchResponse>> findAllCategories( String range, String category) {
        System.out.println(category);
        CountCategorySearchResponse categories = categoryService.getCategories(category, range);
        return new ResponseEntity<>(categories.getResponse(), HttpStatus.OK);
    }
}
